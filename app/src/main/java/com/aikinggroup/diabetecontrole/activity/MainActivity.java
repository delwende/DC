...
import com.aikinggroup.diabetecontrole.adapter.HomePagerAdapter;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            ...
            getSupportActionBar().setTitle("DiabeteControle");
        }
     ...
     //   String action = intent.getAction();
      ...
      /*  Constants.app.getEmailPassword().confirmUserAsync(token, tokenId, it -> {
            if (it.isSuccess()) {
        ...
        DrawerBuilder drawerBuilder = new DrawerBuilder()
                ...
                .withAccountHeader(new AccountHeaderBuilder()
                        .withActivity(this)
                        .withHeaderBackground(R.drawable.head_icon6)
                        .build()
                )
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        // Donate
                            User user =Constants.app.currentUser();
